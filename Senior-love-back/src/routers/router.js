...
router.route('/myprofile')
      ...
      .delete(authenticate, profileController.deleteUser)

// Page profil public
router.route('/profile/:pseudo')
      .get(authenticate, profileController.getOne)
      


// Page des profils utilisateurs      
router.route('/meet')
      .get(authenticate, profileController.getAll)

// Page des contacts avec qui l'utilisateur à échangé des messages
router.route('/messaging')
      .get(authenticate, messageController.getContacts)

// Page de la messagerie avec historique de conversation
router.route ('/message/:id')
      .get(authenticate,validateIdParam, messageController.getMessages)
      .post(authenticate, validate(createMessageSchema),validateIdParam, messageController.create)
...
// Page des Evenements
router.route('/events')
      .get(authenticate, eventController.getAll)

// Ajout d'un évenement - si admin
router.route('/event/form')
      .post(authenticate, validate(createEventSchema), isAdmin, eventController.create)
